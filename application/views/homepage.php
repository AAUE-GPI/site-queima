...
<div class="row" style="margin: 0">
	<div class="col-xs-6">
		<img style="width: 100%; " src="<?php echo base_url() ?>assets/barrahome.svg">
	</div>
	<div class="col-xs-6">
		<img style="width: 100%; " src="<?php echo base_url() ?>assets/barrahome.svg">
	</div>
...
<div class="row" style="margin: 0">
	...
	<div class="col-xs-6" style="padding: 0">
		...
		<a href="https://www.google.com/maps/place/38%C2%B034'27.3%22N+7%C2%B054'18.6%22W/@38.5742552,-7.9073557,17z/data=!3m1!4b1!4m5!3m4!1s0x0:0x0!8m2!3d38.574251!4d-7.905167?hl=en-US"
		   target="blank" class="maparecinto"><h1><span class="glyphicon glyphicon-map-marker"></span>Mapa do Recinto
			</h1></a>
	</div>
</div>
